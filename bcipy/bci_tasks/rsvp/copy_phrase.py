...
class RSVPCopyPhraseTask(Task):
    ...
    def execute(self):
        ...
        while run:
            ...
            novel_stimulus_array = insert_novel_stimulus(target_letter=target_letter, counter_pos=seq_counter, stim_sequence=self.rsvp.stim_sequence, parameters=self.parameters)
            ...
            display_novel_stimulus(win=self.rsvp.win, parameters=self.parameters, clock=self.experiment_clock, counter_pos=seq_counter)
