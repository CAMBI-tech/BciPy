...
def load_data_inquiries(
    ...
    log.info(
        ...
        f"Window_length: {window_length}s, Prestimulus: {pre_stim}s, Buffer: {buffer}s \n"
    ...
    return raw_data, trial_data, labels, trigger_timing, channel_map, window_length, default_transform, drop_log, channels_used, device_spec
