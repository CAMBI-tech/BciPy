...
from bcipy.signal.model.pca_rda_kde.dimensionality_reduction import DummyPCA
...
class RdaKdeModel(SignalModel):
    ...
    def fit(self, train_data: np.array, train_labels: np.array) -> SignalModel:
        ...
        """
        model = Pipeline([DummyPCA(), RegularizedDiscriminantAnalysis()])
        # Flatten data, to simulate what PCA would have done    
