""" Offline Analysis Screen. % Generates the information figure following the offlineAnalysis.
...
ax1.set_title('Mean distractor ERP (averaged over trials in the calibration data')
