...
shouldExecute = raw_input("This function will overwrite the existing parameters.json file, and does not create replacement isNumeric values. Run anyway? (Y/N)")
if(shouldExecute == "Y" or shouldExecute == "y"):
    try:
