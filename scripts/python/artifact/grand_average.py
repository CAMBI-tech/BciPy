...
if __name__ == "__main__":
    ...
    evokeds_erp_compare = dict(cf_auto=list(target_cf_auto.pick_channels(roi).iter_evoked()),
        cf=list(target_cf.pick_channels(roi).iter_evoked()),
        cf_sar=list(target_cf_sar.pick_channels(roi).iter_evoked()))
    fig = mne.viz.plot_compare_evokeds(evokeds_erp_compare, combine='mean', show=True, ci=False, show_sensors='upper right')
